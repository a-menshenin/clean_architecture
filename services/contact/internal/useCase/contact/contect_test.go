...
import (
	...
	mockStorage "architecture_go_2/services/contact/internal/repository/storage/mock"

	"architecture_go_2/pkg/type/context"
	"architecture_go_2/pkg/type/email"
	"architecture_go_2/pkg/type/gender"
	"architecture_go_2/pkg/type/phoneNumber"
	"architecture_go_2/services/contact/internal/domain/contact"
	"architecture_go_2/services/contact/internal/domain/contact/age"
	"architecture_go_2/services/contact/internal/domain/contact/name"
	"architecture_go_2/services/contact/internal/domain/contact/patronymic"
	"architecture_go_2/services/contact/internal/domain/contact/surname"
...
func TestContact(t *testing.T) {
	...
	ucContact = New(storageRepository)

	assertion := assert.New(t)
	t.Run("create contact", func(t *testing.T) {
		var ctx = context.Empty()

		result, err := ucContact.Create(ctx, createContacts...)
	...
	t.Run("get contact", func(t *testing.T) {
		...
		result, err := ucContact.ReadByID(ctx, createContacts[0].ID())
		assertion.NoError(err)
